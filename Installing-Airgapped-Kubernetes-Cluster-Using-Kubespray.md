...
### B) `inventory/mycluster/group_vars/all/offline.yml`
```yaml
---
...
[↩ back to YMLs list](#gv-list)
<a id="gv-k8s"></a>
### C) `inventory/mycluster/group_vars/k8s_cluster/k8s-cluster.yml`
```yaml
---
...
[↩ back to YMLs list](#gv-list)
<a id="gv-cni"></a>
### D) Custom CNI via Helm — `inventory/shahkar/group_vars/k8s_cluster/k8s-net-custom-cni.yml`
...
### E) `inventory/mycluster/group_vars/all/containerd.yml`
```yaml
---
...
### F) Offline Lists (from contrib/offline)
